...
1. Entrer dans le dossier `cluny-musique`

2. Sélectionner toutes les images

3. Édition > Renommer (F2)

4. Donner comme nouveau nom `cluny-##`, début `1`, pas `1`
...
2. Ouvrir l'éditeur de métadonnées IPTC (Ctrl + i ou Cmd + i)

3. Ajouter des infos dans Légende
...
3. Renommer les images pour qu'elles portent le numéro inscrit en haut de la page de droite : il faut obtenir une liste qui ressemble à `p-80.JPG`, `p-82.JPG`, `p-84.JPG`… **ATTENTION** ! comme je suis un peu stupide, j'avais oublié de photographier les deux premières pages, elles sont à la fin du dossier : je veux donc 
...
Il est totalement interdit de renommer les images une par une…
...
2. La télécharger et l'afficher dans XnView        
...
IIIF = *International Image Interoperability Framework*, une communauté d'institutions patrimoniales qui propose un cadre d'interopérabilité pour partager des images en HD sur le web.
